...
const COLOR_CLASSES = ['invalid-cell', 'mms-course-list1', 'mms-course-list2', 'mms-course-list3', 'mms-course-list4', 'mms-course-list0', 'compulsory']; // list of classes used for colouring cells - used when clearing plans
...
function updateColorLegend() {
    ...
    color.css('background-color', colorMappings['.compulsory']);
    title.text('Compulsory Courses');
    row.append(color);
    row.append(title);
    section.append(row);
}
